...
typedef struct _MP3FrameInfo {
	...
	int version;
//zkrt define	
	int number_out_samples;  //number of output samples = nGrans * nGranSamps * nChans
...
void Convert_Mono_zkrt(short *buffer, int outsamples);
void Convert_Stereo_zkrt(short *buffer, int outsamples);
#ifdef __cplusplus
}
#endif
