 ...
 * @version V0.0.0
 * @date    25-August-2017
 * @brief   This file contains psdk system wrapper functions prototypes for RTOS rt-thread,
...
#define PSDK_DBG_PRINTF             rt_kprintf

//set malloc & free function; if use operating system, must be thread safe
#define PSDK_MEM_MALLOC             rt_malloc
#define PSDK_MEM_FREE               rt_free

#if PSDK_ARCH_USE_OS
//define mutex type
#define PSDK_MUTEX_T                rt_mutex_t
